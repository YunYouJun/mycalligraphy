...
var S = {
  init: function () {
    ...
    if (i !== -1) {
      ...
      S.UI.simulate('#countdown 3||');//Shape|Shifter|Type|to start|#rectangle|
    }
...
S.Dot = function (x, y) {
  ...
  this.c = new S.Color(FontColor.r, FontColor.g, FontColor.b, this.p.a);
...
S.ShapeBuilder = (function () {
  var gap = 13,
      ...
      //fontSize = 500,
      fontFamily = fontname + 'Avenir, Helvetica Neue, Helvetica, Arial, sans-serif';
